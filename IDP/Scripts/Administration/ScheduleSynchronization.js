    ...
    $.ajax({
        ...
        success: function (data) {
            if (data !== null && data !== "") {
                ...
                var startTime = "";
                if (item.StartDateString.endsWith("AM") || item.StartDateString.endsWith("PM")) {
                    startTime = new Date(item.StartDateString);
...
function renderSchedulePopUp() {
    ...
    if (zoneDateTime.endsWith("AM") || zoneDateTime.endsWith("PM")) {
