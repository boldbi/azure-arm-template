    ...
    if (objectSelected.length > 0) {
        ...
        $.ajax({
            ...
            success: function (result) {
                var gridObj = $("#Grid").data("ejGrid");
                var statusHtml = "<h5>Import group - Status</h5><table style='text-align: left;table-layout:fixed;' class='table table-striped table-hover post-success-table'><thead class='thead-default'><tr><th>Group name</th><th>Users imported</th><th title='Invalid email address&#13;Duplicated email address'>Users not imported</th><th>Status</th></tr></thead>";
