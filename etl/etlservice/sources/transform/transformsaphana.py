...
print("Generated CREATE TABLE Query for saphana:")
print(create_query)

print("\nGenerated INSERT INTO Query for saphana:")
print(insert_query)
...
try:
    with con.cursor() as cur:
        ...
        try:
            ...
            print(f"Error executing inserting data - ", e)
except dbapi.DatabaseError as db_err:
    # Handle any errors that occur during the database connection
    print("Error while connecting to the saphana database:", db_err)
