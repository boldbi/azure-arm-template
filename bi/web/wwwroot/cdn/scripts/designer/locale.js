    ...
    App: {
	    ...
	    fieldNameChange: {
            ...
            downloadUpload: {
				...
				uploadPageDialogCloseContent: "The changes made to the dashboard is saved as drafts. You can restart the upload process from the ",
		...
		oauthDriveButtonLable: "Select a file from the drive",
			...
			boldbiaiassistant: {
				...
				widgetMessage: "The visualization has been successfully created in the top-left corner of the designer.",
				...
				activationFailed: "Activation failed. Please try again or contact support for assistance. Refer to the guide for more information.",
