...
var NumberFormatting = /** @class */ (function () {
    ...
    NumberFormatting.prototype.applyFormat = function (value, valueRepresentation) {
        ...
        if (valueRepresentation.format !== Format.Percentage && valueRepresentation.decimalSeparator !== null && valueRepresentation.groupSeparator !== null && !BoldBIDashboard.isNullOrUndefined(value)) {
            ...
            value = splitDecimalValue.length > 1
                ? splitDecimalValue[0] + valueRepresentation.decimalSeparator.AliasValue + splitDecimalValue[1]
                : splitDecimalValue[0];
        }
    ...
    NumberFormatting.prototype.applyStringFormatting = function(stringFormat, culture, unit, value, negativeValueFormat) {
...
(function(bbdesigner$, BoldBIDashboard, undefined) {
    BoldBIDashboard.widget('BoldBIDashboardKPICard', 'BoldBIDashboard.KPICard', {
        ...
        getFontHight: function() {
			...
			} else if(this.model.size.width >= 447 && this.model.size.height < 296) {
            ...
            if (cardHt < wrapperHt) {
                ...
                if (cardHt > tempHt) {					
                    ...
                    if(this.model.size.width >= 447 && this.model.size.height < 296) {						
		...
		rearrangeElements: function(){
			...
			} else if(this.model.size.height >= 296){
				this.element.find('.e-kpi-card-value-wrapper').removeClass('e-kpi-card-default-layout');
		...
		updateMargins: function() {
			var isHorizontal = this.model.size.width >= 447 && this.model.size.height < 296;
