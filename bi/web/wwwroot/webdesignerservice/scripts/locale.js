    ...
    App: {
        LocalizationContent: {
            ...
            propertyPanel: {
                ...
                gridPerformanceDelayMsg: "Enabling this property will disable virtual loading in the Grid, which can cause performance delays when working with large sets of records",
                ...
                frozenSettings: {
                    frozenTitle: "Frozen Settings",
                    enableFrozen: "Enable Frozen",
                ...
                designBasicSettings: {
                    ...
                    widgetClubSize: "Batch Size",
                    widgetClubSizeInfo: "Specifies the number of widgets bundled into each API request; requests are issued sequentially until all widgets are sent.", 
                    enablePageWiseLoading: "Enable Page Wise Loading",
                    enablePageWiseLoadingInfo: "Loads widgets sequentially by page; the next page renders only after the current page completes.",
                },
                exportSettings: {
                ...
                basicSettings: {
                    ...
                    seriesCornerRadius: "Corner Radius",
                    areaBorder: "Border",
                    ...
                    enableLazyLoad: "Enable Lazy Load",
                    enableLazyLoadInfo: "Enable this option to render widgets only for the active tab. Widgets in other tabs will load when you switch to them, if they haven’t been rendered yet.",
				...
				chartLineStyleSettings: {
                    ...
                    borderStyleText: "Border Style",
                    borderColorText:"Border Color",
                    borderStyleDialogTitleText: "Custom Border Style Settings",
                ...
                fontSettings: {
                    ...
                    widgetFontFamilyStyle: "Widget Font-Family/Style",
                    autoFontFamilyStyle: "Auto Font-Family/Style",
                    useDashboardFontFamilyStyle: "Use Dashboard Font-Family/Style",
                    useWidgetFontFamilyStyle: "Use Widget Font-Family/Style",
                    fontCustomizationAlertTitle: "Font Customization",
                    modernWidgetFontCustomizationWarning: "Custom font family and style settings are supported only for Modern widgets. Do you want to continue?",
                    headerFontFamilyStyle: "Header Font-Family/Style",
                    contentFontFamilyStyle: "Content Font-Family/Style",
                ...
                pivotFormattingSettings: {
                    ...
                    includeSubTotalCells: "Include Sub Total Cells"
                },
                alignmentSettings:{
				...
				noDataContainerSettings: {
					...
					enableAutoFontSize: "Auto Font Size",
					fontSize: "Font Size"
				},
				interWidgetLinking:{
            ...
            loadingMessages: {
                preparingLayout: "Preparing dashboard layout...",
                loadingWidgets: "Rendering dashboard widgets...",
                dashboardReady: "Dashboard rendered",
                fetchingData: "Fetching data...",
                allWidgetsLoaded:"All widgets loaded successfully",
                widgetsReady:"widgets ready",
                widgetLoadingTitle: "Widget Loading Progress",
                progressBadgeTooltip: "Widget progress",
                badgeAriaLabel: "{0} of {1} widgets ready",
                ready: "Ready",
                loading: "Loading…",
                failed: "Failed",
                someWidgetsMayTakeLonger: "Some widgets may take longer to load",
                initializingWidget: "Initializing widget…",
                preparingView: "Preparing view…",
                loadingData: "Loading data…",
                processingData: "Processing data…",
                processingLargeDataset: "Processing large dataset…",
                finalizingWidget: "Finalizing…",
                widgetReady: "Widget ready",
                failedWidget:"Unable to load widget",
                refreshData:"Refreshing data",
                noDataConfigured: "No data configured",
                deferred: "Deferred",
                deferredTabWidget: "Deferred(Tab Widget)",
            },
            dataSource: {
                ...
                dashboardExpression: "Expression",
		...
		countDistinctExpression: "COUNT(DISTINCT()) restricted in the Expression. Instead, use COUNTD().",
            ...
            alertWindowMesages: {
                ...
                timeLimitExitMessage: "Query exceeded the 3-minute limit. Optimize using filters or indexing.",
				joinsLimitExitMessage: "Multiple joins detected. Simplify using filters or a server-side view.",
				rowLimitExitMessage: "Large data volume detected. Use filters, indexes, or view for better performance.",
		...
		oracleNetSuite: {
            ...
            dialogOptions: {
                ...
                showCustomOption: "Show Custom Option",
                customOptionInfo: "This option allows you to show or hide custom settings when relative date options are available."
            },
            ...
            expressionDesigner: {
                ...
                expressionHelper: {
                    ...
                    sumDistinctDesc: "SUMD sums only the distinct values of the expression, ignoring duplicates. Use it when duplicates from joins or repeated rows would otherwise inflate totals (e.g., summing order revenue joined to line items). In Looker, you can implement this with SUM(DISTINCT ...) in a custom SQL measure, or by using sql_distinct_key to enforce distinctness by a chosen key.",
				}
            },
            queryJoiner: {
                merge: "Merge",
            ...
            loadingIndicatorMessage: {
                ...
                openDashboardText: "Opening Dashboard"
            },
            saveMenuItemsText: {
                publish: "Publish",
            ...
            banerPanel: {
				...
				showCsvDoubleQuotes: "Show Disable Double Quotes",
                ...
                shimmerLoadingIndicator: "Modernized Loading Indicator",
                widgetLoadingProgress: "Show Widget Loading Progress",
                showInBanner: "Show Progress Bar",
                showInDetailsView: "Show Widget Details List",
                showInWidgets: "Show Widget Loading Status",
            ...
            axisRangeSettingsValidation: {
                ...
                logarithmicValidation: "Logarithmic axis does not support zero or negative values"
            },
            enableFilter: {
            ...
            measureFormatting: {
                ...
                measureFormatTypeDuration: "Duration",
				measureFormatDurationBaseUnit: "Base Unit",
				measureFormatDurationFormat: "Duration Format",
				measureFormatDurationSeconds: "Seconds",
			...
			widgetConfiguration: {
				...
				azureKeyConfiguration: {
					inputKeyPlaceHolder: "Enter your Azure Maps key here",
					keyValidationText: "Invalid key. Please enter a valid Azure Maps subscription key.",
					azureMapUploadDialogTitle: "Azure Maps",
					azureKeyDisableAlertMessage: "Are you sure you want to save the key as empty? This will remove the existing Azure Maps key, prevent Azure Maps widgets from loading in exising dashboards, and restrict adding new Azure Maps widgets.",
					azureKeyDisableDialogTitle: "Disable Azure Maps",
					saveBtnText: "Save",
					cancelBtnText: "Cancel",
            ...
            dataconfiguration: {
                ...
                dimensionFilterInfoIcon: {
                    aggregationColumnDataToolTip: "Nested aggregation is not supported for aggregated expression columns"
                }
            },
		...
		oauthDriveButtonLable: "Select a file from the drive",
                ...
                retainDashboardId: "Retain Dashboard ID",
                retainDashboardIdInfo: "Enable this option to retain the existing dashboard ID from the uploaded dashboard. If the dashboard is deleted or reuploaded, the existing dashboard ID will not be retained, and a new ID will be assigned."
            },
			qandawidget: {
			...
			boldbiaiassistant: {
				...
				AiAgentDocumentLink: "Textual Response",
				AiCopilotDocumentLink: "AI Copilot HelpDocument",
				...
				dashboardRoleMessage: "Generate full dashboards tailored to your role or goals.",
				dashboardSummaryHeading: "The following insights provide a deeper understanding based on the widget data provided.",
				conditionalFormattingUnsupported: "Conditional formatting is not supported for this widget. Use supported charts such as Bar, Column, Grid, Scatter, or Proportion to apply it.",
				InvalidTableObject: "Invalid table object name. Please verify that the selected table exists. The table may not exist, or it may have been recently renamed or deleted on the server.",
				InvalidColumn: "Invalid column. Kindly verify that the selected column is present in the database server. The column either does not exist or was recently renamed or deleted on the server.",
				SsasInvalidCube: "Invalid cube. Kindly verify whether the cube exists in the database server.",
				SsasInvalidMember: "Invalid member. Please verify whether the member exists in the column.",
				InvalidSp: "Invalid Stored Procedure. Please verify that the selected stored procedure exists. The stored procedure either does not exist or has been recently renamed or deleted on the server.",
				DataSerializingError: "An error occurred while deserializing the request payload.",
				DataFetchingError: "An error occurred while fetching data from the data source.",
				FormattingError: "An error occurred while formatting the visual data.",
				addSynonymsText: "Add Synonyms",
				applyBtnText: "Apply",
				cancelBtnText: "Cancel",
				suggestSynonymsText: "Suggest",
				suggestedSynonymsText: "Suggested Column Synonyms",
				suggestedSynonymsSubtitle: "Use common terms as excess synonyms reduce accuracy.",
				suggestValueSynonymsText:"Suggest",
				suggestedValueSynonymsText:"Suggested Value Synonyms",
				synonymsText: "Column Synonyms",
				synonymsSubtitle: "Common ways users refer to this field",
				typeSynonymPlaceHolder:"Type a synonym (e.g., Show, Display, Render)",
				gettingSuggestionsText:"Getting suggestions...",
				valueKeyPlaceholder:"Select a value",
				valueSynonymsText:"Value Synonyms",
				commitText: "Commit",
				addText: "Add",
				valueSynonymsPlaceholder: "Type synonyms as comma-separated (e.g., BLBI, Bold BI)",
				valueSuggestionsEmptyValueMessage: "Please select a value or enter a value to generate synonym suggestions",
				columnSynonymsInfo: "Add alternative names users commonly use to refer to this column. These help the AI map natural language questions to the correct field.",
				columnSynonymsSuggestionsInfo: "AI-suggested synonyms based on dataset context and common business terminology. Review and add only those relevant to your domain.",
				valueSynonymsInfo: "Define alternative names for specific values in this column. This helps the AI recognize domain-specific terms, abbreviations, and aliases.",
				valueSynonymsSuggestionsInfo: "AI-suggested alternatives commonly used to describe this value. Useful for acronyms, industry terms, and user-friendly names.",
				valueSynonymsSuggestionsText: "Review suggestions to ensure they suit your business context.",
				valueSynonymsComboBoxInfo: "Preloaded with top values (up to 1000) from this column. You can also type and add any other value manually.",
				synonymsDialogSubtitle: "Synonyms help the AI better understand your business language and improve question interpretation and intent matching to your data.",
				hideContextText:"- Hide additional context",
				addContextForSuggestionsText: "+ Add context for better suggestions",
				...
				noTablesInDatasource: "The existing data source does not include any tables that are rendered or being queried",
				addColumnDescription: "+ Add Column Description",
				hideColumnDescription: "- Hide",
				columnDescriptionTitle: "Column Description",
                ...
                descriptionPlaceholder: "Describe briefly about the dashboard and the requirements to generate summary",
                restructureButtonText: "Restructure",
                generatedCustomPromptLabel: "Generated Custom Prompt",
                generatedPromptPlaceholder: "Restructured prompt will appear here and can also edit as you need",
                revertDiscardText: "Revert/Discard",
                rephrasingText: "Restructuring...",
				maximumLengthLabel: "Maximum Charcters: ",
				emojisRequiredText: "Emojis Required",
				structurizeFailedMessage: "Failed to generate structured prompt. Please try again.",
				descriptionRequiredText: "Please enter a description",
				customPromptDialogTitle: "Customize Prompt",
				customPromptButttonText: "Customize",
				EnableCustomPrompt: "Enable Custom Prompt",
                descriptionInfoText: "Describe the purpose and behavior you want the AI to follow when summarizing dashboard. Include examples, constraints, or important domain details the assistant should consider",
                generatedPromptInfoText: "This is the structured system prompt the AI will use. You can edit it or revert to regenerate from the description",
			...
			unifiedAiChat: {
				...
				unifiedAIChatExplore: "How can I assist you today?",
				betaName: "Beta",
				noHistoryMessage: "No history found",
				renameButton: "Rename",
				deleteButton: "Delete",
				todayHistoryHeading: "Today",
				yesterdayHistoryHeading: "Yesterday",
				previousHistoryHeading: "Previous",
				newChatName: "New Chat",
				nodashboardOrDataSourceMessage1: "No ",
				nodashboardOrDataSourceMessage2: " present",
				categoryMismatchError: "The question you submitted doesn't align with the selected category. Please choose the correct category and try again",
				summarizationFeatureDisabled: "AI-based summarization and text-based answer features are currently disabled. Please enable them on the site settings or UMS settings.",
				dashboardInfoFetchError: 'Facing issue while fetching Dashboard Information',
				noWidgetsToSummarize: "Please create widgets or charts in the specified dashboard to summarize the data",
				dashboardNotSpecified: "Please specify the dashboard to summarize by using @ to list the available dashboards.",
				datasourceUnavailableOrForbidden: "You either haven't added any data sources yet or lack permission to access data sources.",
				noMatchingDataFound: "No data found for your request. Please verify the data source list and try again, or use @ in the chat to view available data sources and retry.",
				textResponseTooLarge :"I apologize, I can't provide a concise text response because there are more data. Do you want to Visualize?",
				fromTextForSuggestions: "from",
				serviceNetworkFailure: "The service is currently having trouble establishing the connection to the chat model. Please try again later.",
				fetchingColumns: "Fetching Columns...",
				AIAssistantDocumentLink: "AI Assistant HelpDocument",
			...
			replaceValues: { 
                ...
                considerIntegerColumnText: "Replace Null Values In Integer Columns With 0"
			},
			parameterInjection: {
            ...
            metricsContainer: {
                ...
                avgQuery: "Avg Query",
                dataFetchTooltip: "End-to-end data fetching window time for the selected cycle.",
                avgQueryTooltip: "Average widget query execution time for the selected cycle.",
                allTimesInMs: "All times are in milliseconds (ms)",
                capturedAt: "Captured at",
                widgetProcessTimeId: "widget",
                widgetProcessTime: "Widgets Processing Time",
                dashboardSection: "Dashboard",
                widgetTimingsSection: "Widget Timings",
				...
				liveMode: "Live",
				extractMode: "Extract",
				dataSourceRefreshTime: "Refresh Time",
				dataSourceRefreshStatus: "Status",
				dataSourceGroupID: "DataSource",
				dataSourceGroupName: "Data Source Info",
				noDataSourceMetrics: "No data source metrics available",
				noWidgetMetrics: "No widget timings available",
				widgetDataSource: "Data Source",
				widgetQueryLabel: "Querying",
