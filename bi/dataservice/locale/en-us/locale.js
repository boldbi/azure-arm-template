    ...
    App: {
		...
		oauthDriveButtonLable: "Select a file from the drive",
			...
			boldbiaiassistant: {
				...
				releaseNotes: {
					releaseNote1: "Added drag and resize support for AI-generated widgets over other widgets in design mode.",
					releaseNote2: "Enhanced the quality of widget insights data.",
					releaseNote3: "Updated AI usage details from dollar amounts to token-based metrics for Bold BI service tenants.",
				},
				linkBasedNotes : {
					 releaseNotes1: [
						{
