    ...
    App: {
        LocalizationContent: {
            ...
            dataSource: {
				...
				dataCacheDocMid: "Please switch to Redis for production environments. Refer ",
            ...
            errorCodes: {
                ...
                KeyNotConfigured : 'OpenAI key or model name not configured. Click here to learn more about how to configure OpenAI credentials to enable this feature. ',
                InvalidAPIKey : 'Invalid OpenAI API key. Please ensure that the provided API key is accurate and has not expired. Click here to learn more about how to configure OpenAI credentials. ',
                ...
                MissingOpenAIKey : 'OpenAI key not configured. Click here to learn more about how to configure OpenAI credentials to enable this feature. ',
                MissingOpenAIModel : 'OpenAI model name not configured. Click here to learn more about how to configure OpenAI credentials to enable this feature. ',
                MissingAzureAIKey : 'Azure OpenAI key not configured. Click here to learn more about how to configure Azure OpenAI credentials to enable this feature. ',
                MissingAzureAIResourceName : 'Azure OpenAI Resource name not configured. Click here to learn more about how to configure Azure OpenAI credentials to enable this feature. ',
                MissingAzureAIDeploymentName : 'Azure OpenAI Deployment name not configured. Click here to learn more about how to configure Azure OpenAI credentials to enable this feature. ',
		...
		oauthDriveButtonLable: "Select a file from the drive",
			...
			qandawidget:{
                ...
                dialogClickToSubmitDetails1: "Clicking Submit shares your question, the column names of the data source involved, and the error logs with the ",
