...
6.	[Click here](https://raw.githubusercontent.com/boldbi/azure-arm-template/master/armtemplates/v6.1.8/BoldBIAppServiceTemplate.json) to download the ARM template file.
