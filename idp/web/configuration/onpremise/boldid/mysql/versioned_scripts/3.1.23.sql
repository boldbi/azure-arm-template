...
SET @boldid_column_count := (
    ...
    WHERE TABLE_SCHEMA = DATABASE()
      AND TABLE_NAME = 'BOLDTC_SAMLSettings'
      AND COLUMN_NAME = 'IsSloEnabled'
);
...
SET @boldid_sql := IF(
    ...
    'ALTER TABLE {database_name}.BOLDTC_SAMLSettings ADD IsSloEnabled tinyint NOT NULL DEFAULT 0',
