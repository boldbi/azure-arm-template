    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            if (result.ImportStatus.length > 0) {
                statusHtml += "<h4>" + window.Server.App.LocalizationContent.GroupSynchronize + "</h4><table style='text-align: left;table-layout:fixed;' class='table table-striped table-hover post-success-table'><thead class='thead-default'><tr><th>" + window.Server.App.LocalizationContent.Group + "</th><th>" + window.Server.App.LocalizationContent.UsersAddedToGroup + "</th><th>" + window.Server.App.LocalizationContent.UsersRemovedFromGroup + "</th><th>" + window.Server.App.LocalizationContent.UserSynchronized + "</th><th title=" + window.Server.App.LocalizationContent.UserEmailValidator + "&#13;" + window.Server.App.LocalizationContent.IsDuplicateUserEmail + "'>" + window.Server.App.LocalizationContent.UserNotSynchronized + "</th><th>" + window.Server.App.LocalizationContent.Status + "</th></tr></thead>";
            ...
            var title = synchronizeActiveDirectoryGroupUrl.indexOf("azure") > 0 ? window.Server.App.LocalizationContent.AzureADSync : window.Server.App.LocalizationContent.ADSync;
