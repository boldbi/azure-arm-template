...
$(document).ready(function () {
    $("#PublishItemGrid").ejGrid({
        ...
        groupSettings: { groupedColumns: ['Name'], captionFormat: "#grouping-synchronize-template" },
        pageSettings: { pageSize: 20 },
        enableRowHover: true,
        enableAltRow: false,
        toolbarSettings: { showToolbar: false, toolbarItems: [ej.Grid.ToolBarItems.Search] },
        searchSettings: { fields: ["TenantName", "ItemName", "Name", "Status", "LastUpdatedDateString"], key: "", ignoreCase: false },
        columns: [
            { field: 'Name', headerText: window.Server.App.LocalizationContent.PublishedItemDashboard, templateID: '#dashboard-template', width: 80, allowFiltering: false, allowSorting: true, allowGrouping: true },            
