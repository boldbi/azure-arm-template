$(document).ready(function () {
    ...
    var permissionDeleteWaitingPopupTemplateId = createLoader("permission-delete-confirmation-wrapper");
    $("#permission-delete-confirmation-wrapper").ejWaitingPopup({ template: $("#" + permissionDeleteWaitingPopupTemplateId) });
